...
namespace InternshipManagementSystem.Migrations
{
    ...
    [Migration("20250428014012_AddExamSchedulingFieldsToExam")]
    partial class AddExamSchedulingFieldsToExam
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Exam", b =>
                {
                    ...
                    b.Property<bool>("AllowQuestionTimeLimit")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("InternshipManagementSystem.TrainingManagement.Candidate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InternshipManagementSystem.TrainingManagement.CandidateExamAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("Answer")
                        ...
                        .HasComment("الإجابة النصية للمرشح");

                    b.Property<string>("AnswerFileName")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)")
                        .HasComment("اسم الملف المرفق");

                    b.Property<string>("AnswerFileUrl")
                        .HasMaxLength(512)
                        .HasColumnType("nvarchar(512)")
                        .HasComment("رابط الملف المرفق للإجابة");

                    b.Property<Guid>("CandidateExamAttemptId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double?>("PartialScore")
                        .HasColumnType("float");
                    ...
                    b.HasIndex("CandidateExamAttemptId");

                    b.HasIndex("QuestionId");

                    b.ToTable("AppCandidateExamAnswers", (string)null);
                });

            modelBuilder.Entity("InternshipManagementSystem.TrainingManagement.CandidateExamAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppCandidateExamAttempts", (string)null);
                });

            modelBuilder.Entity("InternshipManagementSystem.TrainingManagement.ExamAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppExamAnswers", (string)null);
                });

            modelBuilder.Entity("InternshipManagementSystem.TrainingManagement.ExamAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsPassed")
                        .HasColumnType("bit")
                        .HasComment("هل المتدرب نجح بالامتحان؟");

                    b.Property<bool>("IsSubmitted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false)
                        .HasComment("هل تم ارسال الاجابات");
                    ...
                    b.ToTable("AppExamAttempts", (string)null);
                });

            modelBuilder.Entity("InternshipManagementSystem.TrainingManagement.ExamLink", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InternshipManagementSystem.TrainingManagement.Specialization", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppSpecializations", (string)null);
                });

            modelBuilder.Entity("InternshipManagementSystem.TrainingManagement.Trainee", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppTrainees", (string)null);
                });
            ...
            modelBuilder.Entity("Question", b =>
                {
                    ...
                    b.Property<string>("CodeExpectedOutput")
                        .HasMaxLength(5000)
                        .HasColumnType("nvarchar(max)")
                    ...
                    b.Property<string>("CodeStarterTemplate")
                        .HasMaxLength(5000)
                        .HasColumnType("nvarchar(max)")
            ...
            modelBuilder.Entity("Exam", b =>
                {
                    b.HasOne("InternshipManagementSystem.TrainingManagement.Specialization", "Specialization")
                        .WithMany("Exams")
            ...
            modelBuilder.Entity("InternshipManagementSystem.TrainingManagement.CandidateExamAnswer", b =>
                {
                    b.HasOne("InternshipManagementSystem.TrainingManagement.CandidateExamAttempt", "CandidateExamAttempt")
                        .WithMany("CandidateExamAnswers")
                        .HasForeignKey("CandidateExamAttemptId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("CandidateExamAttempt");
            ...
            modelBuilder.Entity("InternshipManagementSystem.TrainingManagement.CandidateExamAttempt", b =>
                {
                    b.HasOne("InternshipManagementSystem.TrainingManagement.Candidate", "Candidate")
            ...
            modelBuilder.Entity("InternshipManagementSystem.TrainingManagement.ExamAnswer", b =>
                {
                    b.HasOne("InternshipManagementSystem.TrainingManagement.ExamAttempt", "ExamAttempt")
            ...
            modelBuilder.Entity("InternshipManagementSystem.TrainingManagement.ExamAttempt", b =>
                {
                    ...
                    b.HasOne("InternshipManagementSystem.TrainingManagement.Trainee", "Trainee")
                        .WithMany("ExamAttempts")
