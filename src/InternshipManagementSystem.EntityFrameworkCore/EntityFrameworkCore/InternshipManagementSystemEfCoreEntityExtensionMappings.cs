...
public static class InternshipManagementSystemEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
             ...
             * USE InternshipManagementSystemModuleExtensionConfigurator CLASS (in the Domain.Shared project)
