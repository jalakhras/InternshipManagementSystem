...
namespace InternshipManagementSystem.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        {
            var consoleAndAngularClientRootUrl = configurationSection["InternshipManagementSystem_App:RootUrl"]?.TrimEnd('/');
        ...
        {
            var swaggerRootUrl = configurationSection["InternshipManagementSystem_Swagger:RootUrl"]?.TrimEnd('/');
